...
class OperatorMultiplyTest {
    private val testCases = listOf(
        TestCase(
            "11111111.22222222",
            "22222222.33333333",
            OperandDecimal("246913583950617.2098765425925926")
        ),
        TestCase("0.02", "0.3", OperandDouble("0.006")),
        TestCase("0.0", "0.3", OperandLong("0")),
        TestCase("1234567.0", "10.0", OperandLong("12345670")),
        TestCase("4567890.5", "10.5", OperandDouble("47962850.25")),
        TestCase("888888888888.0", "888888888888.0", OperandDecimal("790123456788543209876544")),
        TestCase("1234567890.23", "10.25", OperandDecimal("12654320874.8575")),
        ...
        TestCase("231344100000000", "15210000", OperandDecimal("3518743761000000000000"))
    )
